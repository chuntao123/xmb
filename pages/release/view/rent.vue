<template>
  <view class="content">
    ...
    <orange-fullloading
	 ...
	 <view>
		 <u-navbar title="出租发布" :backTextStyle="{color:'#ffffff'}" :background="background"></u-navbar>
     </view>
	 <view >
		 <u-notice-bar type="success" :list="list1" ></u-notice-bar>
		  ...
		  <u-form :model="form" ref="uForm">
		 	...
		 	<u-field v-model="form.intro" label-width=50 type="textarea" maxlength=30 placeholder="描述一下你需要出租的宝贝,准确的描述能更快出租哦~"></u-field>
		 	...
		 	<u-field v-model="form.pirce" maxlength=5 label-width=100 icon="rmb" label="价格" input-align="right" placeholder="你希望出租商品的价格" ></u-field>
